...
export default function PostJob() {
  ...
  useEffect(() => {
    ...
    const storedResumes = localStorage.getItem("resume_market");
  ...
  const saveDraft = () => {
    ...
    const next: Position = {
      ...
      requiredSkills: draftSkills,
      company: draftCompany.trim(),
      workType: draftWorkType,
      mode: draftMode,
      city: draftMode === "现场" ? draftCity.trim() : undefined,
    ...
    setPositions((prev) => {
      ...
      if (editingIndex === null || editingIndex === prev.length) {
        ...
        copy[editingIndex] = { ...next, id: copy[editingIndex].id };
      }
